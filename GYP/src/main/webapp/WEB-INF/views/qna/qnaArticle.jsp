...
<body style="font-family: 'Noto Sans KR', sans-serif;">
	...
	<div id="bbsList">
		...
		<div>
			...
			<div id="lists">
				<table width="600" border="0">
					<tr><td class="content" style="padding: 20px 80px 20px 62px;" valign="top" height="200">
					${dto.qnaContent }
					</td></tr>
				</table>
			</div>
			...
			<a href="<%=cp%>/qnaArticle.action?pageNum=${pageNum }&qnaNum=${preQnaNum}">
			${preQnaTitle }
			</a>
			</c:if>
			</div>
			...
			<a href="<%=cp%>/qnaArticle.action?pageNum=${pageNum }&qnaNum=${nextQnaNum}">
			${nextQnaTitle }
			</a>
			</c:if>
			</div>
		...
		<div id = "bbsArticle_footer">
			<div id="leftFooter">
			<input type="button" value="답글" class="btn2" 
				onclick="sendData();">
