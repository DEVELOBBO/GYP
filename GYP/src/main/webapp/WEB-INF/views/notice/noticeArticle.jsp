...
<body style="font-family: 'Noto Sans KR', sans-serif;">
	...
	<div id="bbsList">
		...
		<div>
			...
			<a href="<%=cp%>/noticeArticle.action?pageNum=${pageNum }&notiNum=${preNotiNum}">
			${preNotiTitle }
			</a>
			</c:if>
			</div>
			...
			<a href="<%=cp%>/noticeArticle.action?pageNum=${pageNum }&notiNum=${nextNotiNum}">
			${nextNotiTitle }
			</a>
			</c:if>
			</div>
