		...
		<form action="" name="myForm" method="post">
			<div id="bbsCreated">
				<div class="bbsCreated_bottomLine">
					<dl>
						<dt>아&nbsp;&nbsp;이&nbsp;&nbsp;디</dt>
						<dd>
							<input type="text" name="cusId" size="74" maxlength="100"
								class="boxTF" />
						</dd>
					</dl>
				</div>
				...
				<div class="bbsCreated_bottomLine">
					<dl>
						<dt>이름</dt>
						<dd>
							<input type="text" name="cusName" size="35" maxlength="20"
								class="boxTF" />
						</dd>
					</dl>
				</div>
				...
				<div class="bbsCreated_bottomLine">
					<dl>
						<dt>비밀번호</dt>
						<dd>
							<input type="password" name="cusPwd" size="35" maxlength="50"
								class="boxTF" />
						</dd>
					</dl>
				</div>
				...
				<div class="bbsCreated_bottomLine">
					<dl>
						<dt>비밀번호 확인</dt>
						<dd>
							<input type="password" name="cusPwd2" size="35" maxlength="50"
								class="boxTF" />
						</dd>
					</dl>
				</div>
				...
				<div class="bbsCreated_bottomLine">
					<dl>
						<dt>이메일</dt>
						<dd>
							<input type="text" name="cusEmail" size="35" maxlength="50"
								class="boxTF" />
						</dd>
					</dl>
				</div>
				...
				<div class="bbsCreated_bottomLine">
					<dl>
						<dt>전화번호</dt>
						<dd>
							<input type="text" name="cusTel" size="35" maxlength="50"
								class="boxTF" />
						</dd>
					</dl>
				</div>
				...
				<tr>
					<td width="100%" height="50%" align="center">
						...
						<textarea rows="20" cols="150">
					     미안하다 이거 보여주려고 어그로끌었다.. 나루토 사스케 싸움수준 ㄹㅇ실화냐? 진짜 세계관최강자들의 싸움이다.. 그찐따같던 나루토가 맞나? 
			...
			<div id="bbsCreated_footer">
				<input type="button" value=" 등록하기 " class="btn2"
					...
					onclick="javascript:location.href='/gyp/createCustomer.action'" />
			</div>
		</form>
